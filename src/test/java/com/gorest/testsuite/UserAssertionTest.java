...
//7. Verify the Gender = male of username is “Dhanalakshmi Pothuvaal”
    ...
    //2. Verify if the name of id = 5914143 is equal to ”Himadri Banerjee”
    @Test
    public void test002() {
    ...
    //6. Verify the status is “Active” of username is “Asha Pandey”
    @Test
    public void test006() {
        response.body("find{it.name == 'Asha Pandey'}.status", equalTo("active"));
    }

    //7. Verify the Gender = male of username is “Paramartha Kocchar”
    @Test
    public void test007() {
